...
void OpenGL::loadExtensions()
{
    ...
    gOpenGL.glGenerateMipmap = (GenerateMipmap)glGetProcAddress("glGenerateMipmap");
    
    gOpenGL.glGenBuffers    = (GenBuffers)glGetProcAddress("glGenBuffers");
    gOpenGL.glBindBuffer    = (BindBuffer)glGetProcAddress("glBindBuffer");
    gOpenGL.glBufferData    = (BufferData)glGetProcAddress("glBufferData");
    gOpenGL.glDeleteBuffers = (DeleteBuffers)glGetProcAddress("glDeleteBuffers");
